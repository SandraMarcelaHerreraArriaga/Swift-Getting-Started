...
/*:
 ...
 To check if first letter of a string matches a certain character, you can use code to the following form:
...
/*:
 ## Challenge 2
 You can write an even more compact form to the loop above, using where clause as part of your for loop condition
