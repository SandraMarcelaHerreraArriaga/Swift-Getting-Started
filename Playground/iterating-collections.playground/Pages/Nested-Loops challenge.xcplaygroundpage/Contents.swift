 ...
 **********
 ...
 your first (outer) loop should go form one to 5 incluive.
 Your second (inner) loop should go form one to 10 inclusive.
 You don't care about either loop variable in this case, you can ignore them
 The print statement inside the inner loop should be print("*", terminator= "") with
will print a string without the \n newline character at the end. This will let you string together your asterisks.
 
 You will also need a print statement after the inner loop finishes, to print a newline so that the next row of asterisks prints on a new line. You can do this with a simply print()
...
/*:
 ...
 You're having a sale in your pastry shop - but only on the pastries that are five characteres in length or less. Create a loop that will print out the pastries that are on sale.
